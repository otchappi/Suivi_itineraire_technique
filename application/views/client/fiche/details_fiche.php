						...
						<?php 
							if(isset($document))
							{
								...
								{											
									...
									{
										?>
										<a class="btn-wide btn-shadow btn btn-outline-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?=$row->titre_document?>" href="<?=base_url($row->emplacement_document);?>" target="_blank">
								...
								{
									?>
									<span style="font-size:1.1em; font-weight: bold;">Aucun document disponible</span>
									<?php
								}
							}
						?>
