...
(function($) {
	...
	$.fn.fileuploader.defaults = {
        ...
        captions: {
            ...
            feedback: function(options) { return 'Choisir ' + (options.limit == 1 ? 'le fichier' : 'les fichiers') + ' à télécharger'; },
            feedback2: function(options) { return options.length + ' ' + (options.length > 1 ? ' fichiers ont été' : ' fichier a été') + ' choisis'; },
            drop: 'Déposez les fichiers ici pour Uploader',
            paste: '<div class="fileuploader-pending-loader"><div class="left-half" style="animation-duration: ${ms}s"></div><div class="spinner" style="animation-duration: ${ms}s"></div><div class="right-half" style="animation-duration: ${ms}s"></div></div> En collant un fichier, cliquez ici pour annuler.',
            ...
            errors: {
                ...
                fileSize: '${nom} est trop grand ! Veuillez choisir un fichier jusqu\'à ${fileMaxSize}MB.',
                filesSizeAll: 'Les fichiers que vous avez choisis sont trop grand ! Veuillez télécharger des fichiers jusqu\'à ${maxSize}. MB.',
                fileName: 'Le fichier portant le nom ${nom} est déjà sélectionné.',
